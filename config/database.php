...
return [
    ...
    */
    ...
    'connections' => [
        ...
        /*
         * The ai-memory index, read-only. This is not the app's own storage —
         * it is another product's database, living on this same host, written
         * exclusively by the ai-memory service. See config/aimemory.php and
         * docs/read-only.md for why nothing here may ever write.
         */
        'aimemory' => [
            'driver' => 'sqlite',
