...
/**
 * Regression tests for the availability guard.
 *
...
class AiMemoryDatabaseTest extends TestCase
{
    ...
    public function test_it_degrades_when_a_wal_reader_cannot_create_the_sidecar_files(): void
    {
        ...
        $this->assertStringContainsString('WRITE permission on the directory', (string) $db->unavailableReason());
    ...
    public function test_it_degrades_when_the_file_is_missing(): void
    {
        ...
        $this->assertStringContainsString('does not exist', (string) $db->unavailableReason());
    }
